...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/rkmovieszip')
...
START_IMG = environ.get('START_IMG', 'https://telegra.ph/file/c213860d5a4f89a87b84d.jpg')
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002244213312'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002244213312'))
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/rkmoviezip")
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002067412286'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002177424257')
